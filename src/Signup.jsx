    ...
    if (localStorage.getItem("token")) {
        ...
        return (
            ...
            <div className="flex flex-col items-center py-20 md:py-10">
                <h1 className="text-3xl text-blue font-bold py-9 text-slate-500 font-poppins">Signup Page</h1>
                ...
                <form className="flex flex-col gap-5 font-inter " onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col gap-2" >
                        ...
                        <input
                            className="w-full  py-1.5 border-b-2 focus:outline-none  text-blue placeholder:text-gray-400 sm:text-sm sm:leading-6"                            required
                            type="password"
                            name="password"
                            id="password"
                    ...
                    <Link className="mt-2 font-semibold leading-6 text-pink hover:text-indigo-500" to="/login">Already registered? Sign in</Link>
                </div>
            </>
        );
    }
